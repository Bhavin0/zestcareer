                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     	<div class="panel panel-primary">
	                        <div class="panel-heading">
	                           <span class="title elipsis"><strong>Add Material</strong></span>
	                        </div>
	                        <div class="panel-body">
	                        	<form action="" method="post" enctype="multipart/form-data">
	                                ...
	                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
                                     ...
                                     <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
                                        <label><b>Material Date</b></label>
                                        <input type="text" name="data[sm_createdon]" value="<?php echo date('Y-m-d'); ?>" class="form-control datepicker masked" required="required">
                                    </div>

	                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
	                                	<label><b>Material Title</b></label>
	                                	<input type="text" name="data[sm_name]" class="form-control" required="required">
	                                </div>
	                                ...
	                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
	                                	...
	                                	<textarea class="summernote form-control" name=data[sm_description] data-height="200" data-lang="en-US"></textarea>
	                                </div>
	                                ...
	                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
	                                	<button type="submit" class="btn btn-primary pull-right" name="add_material" value="add_material">
	                                		ADD MATERIAL
	                                	</button>
	                                </div>
	                            </form>
