                            ...
                            <table class="fooTableInit">
                                ...
                                <?php $i = 1; while($album = mysqli_fetch_assoc($albums)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?pid=54&action=upload_photos&album_id=<?php echo $album['photo_galleryid']; ?>" class="btn btn-info btn-xs">&nbsp;<i class="fa fa-eye"></i></a>
                                            <a href="?pid=54&action=edit_album&album_id=<?php echo $album['photo_galleryid']; ?>" class="btn btn-warning btn-xs">&nbsp;<i class="fa fa-pencil-square-o"></i></a>
                                            <a href="?pid=54&action=delete_album&album_id=<?php echo $album['photo_galleryid']; ?>" onclick="return confirm('are you sure? you want to delete it?')" class="btn btn-danger btn-xs">&nbsp;<i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
