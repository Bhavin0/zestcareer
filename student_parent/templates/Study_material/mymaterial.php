					...
					<div id="panel-1" class="panel panel-primary">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>Materials</strong> <!-- panel title -->
							</span>
							...
							<table class="fooTableInit"><!-- add .fooMinimal for minimal skin and remove foo css theme (footable.standalone.css) -->
								...
								<?php $i = 1; while($material = mysqli_fetch_assoc($materials)) { ?>
									<tr>
										...
										<td>
											<a href="?pid=34&action=view_material_detail&studymaterialid=<?php echo $material['es_studymaterialid']; ?>" class="btn btn-info btn-xs">&nbsp;<i class="fa fa-eye"></i></a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
