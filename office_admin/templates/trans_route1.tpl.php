				...
				<table width="100%" border="0" cellspacing="3" cellpadding="0">	
					...
					<td align="left"><span class="narmal">
					 <select name='route_via' style=" width:255px;" >
						...
						$country_query="SELECT * FROM es_translist";
						$country_row = $db->getRows($country_query);	
						foreach($country_row  as  $country_name){
						
						?>
                     <option value='<?php echo $country_name['id'];?>'  <?php if( $country_name['id']==$country){ echo "selected"; }?>><?php echo ucfirst($country_name['route_title']);?></option>
                     <?php }   ?>
                   </select>
