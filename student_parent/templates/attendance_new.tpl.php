                    ...
                    <tr>
					  ...
					  <tr>
						...
						<tr>
							...
							<input name="Submit22" type="button" onclick="newWindowOpen ('?pid=27&action=printslip');" class="bgcolor_02" style="cursor:pointer;" value="Print" />
							</td>
		...
		<form name="attend_stud" action="" method="post" >
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
				<div class="input-group">
					<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
						<input name="at_attendance_date"  id="at_attendance_date"  value="<?php if (isset($at_attendance_date)){ echo $_POST['at_attendance_date']; }elseif (isset($getmaintenance->at_attendance_date)){ echo $getmaintenance->at_attendance_date; } else { echo date('d/m/Y'); } ?>" class="form-control datepicker" data-format="dd/mm/yyyy" data-lang="en" data-RTL="false" />
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
				<select name="at_std_class" onchange="JavaScript:document.attend_stud.submit();" class="form-control selectpicker" data-live-search="true">
					...
					?>
					<option value="<?php echo $indclass['es_classesid']; ?>" <?php echo ($indclass['es_classesid']==$at_std_class)?"selected":""?> >
						<?php echo $indclass['es_classname']; ?>
					</option>
					<?php } ?>
				</select>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
				<table class="table table-bordered table-condensed table-striped">
					...
					?>
		  				<tr>
							<td>
								<?php echo $slno;?>
								<input name="at_reg_no[]" type="hidden" value="<?php echo $student['es_preadmissionid']; ?>" />
							</td>
							<td>
			  					<?php  echo $student['pre_name']." ".$student['middle_name']." ".$student['pre_lastname']; ?>
			  					<input type="hidden" name="at_stud_name[]" value="<?php  echo $student['pre_name']." ".$student['middle_name']." ".$student['pre_lastname']; ?>" />
			  				</td>
							<td>
			 					<select name="at_attendance[]">
			 						<option value="P">P</option>
			 						<option value="A">A</option>
			 					</select>
			 				</td>				  
							<td>
			  					<input name="at_remarks[]" type="text" class="form-control" />
			  				</td>
						</tr>
		 			<?php 
		  			$rw++;
		 	...
		 	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
				<input name="stud_attend_Submit" type="submit" class="btn btn-primary pull-left" value="Submit" />
			</div>
		   ...
		   <?php 
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				  ...
				  <input name="staff_attend_Submit" type="submit" style="cursor:pointer;" class="bgcolor_02" value="Submit" />
&nbsp;
...
?>
                      ...
                      <table width="100%" height="33" border="0">
                        <tr>
						  ...
						  <input name="Submit22" type="button" onclick="newWindowOpen ('?pid=55&action=print_stud_report<?php echo $studurl;?>');" class="bgcolor_02" style="cursor:pointer;" value="Print" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	?>		             <tr class="<?php echo $rowclass;?>">
							...
							<a href="javascript:void(0)" onclick="window.open('?pid=27&action=class_report_absent&classid=<?php //echo $at_std_class_report;?>&caid=<?php //echo $studentreport['at_reg_no']."&cadf=$from_acad&cadt=$to_acad" ;?>',null,'width=600,height=400,left=50,top=30,scrollbars=yes,menubar=yes');"><?php //echo viewIcon();?></a>
<?php //} ?>--></td>
	...
	<?php 
			...
			$slno++;
			 ...
			 <tr>
				 ...
				 <td align="center">&nbsp;</td>
				 <td> 
				<input type="button" value="Print" onclick="newWindowOpen ('?pid=27&action=print_class_report<?php echo $printpassurl;?>');" style="cursor:pointer;" class="bgcolor_02"/>
...
?>		             <tr class="<?php echo $rowclass;?>">
	...
	<?php 
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td><!--<input type="button" value="Print" onclick="newWindowOpen ('?pid=27&action=print_class_report<?php //echo $printpassurl;?>');" style="cursor:pointer;" class="bgcolor_02"/>-->
...
?>                      <tr class="<?php echo $rowclass;?>">
                        ...
                        <td align="center" class="narmal"><?php echo $presentdays;?></td>
						<td align="center"  class="narmal"><?php echo $absent;?><?php if($absent!= 0) {  ?>&nbsp;
					<a href="javascript:void(0)" onclick="window.open('?pid=27&action=staff_report_absent_date&caid=<?php echo $at_staffid."&from=$from&to=$to";?>',null,'width=600,height=400,left=50,top=30,scrollbars=yes,menubar=yes');"><?php echo viewIcon();?></a>
...
?>
                      ...
                      <table width="100%" height="33" border="0">
                        <tr>
                          <td align="center" valign="middle">
						 <input name="Submit25" type="button" onClick="newWindowOpen('?pid=27&action=print_staffwise_report<?php echo $staffwiseurl;?>');" class="bgcolor_02" style="cursor:pointer;" value="Print" />
...
?>		
					  <tr class="<?php echo $rowclass;?>">
						...
						<td align="center" class="narmal"><?php echo $absent;?><?php if($absent!= 0) { ?>&nbsp;
						<a href="javascript:void(0)" onclick="window.open('?pid=27&action=staff_report_absent&caid=<?php echo $staffreport['at_staff_id'];?>&sabf=<?php echo $from_acad; ?>&sabt=<?php echo $to_acad; ?>',null,'width=600,height=400,left=50,top=30,scrollbars=yes,menubar=yes');"><?php echo viewIcon();?></a>
...
<?php 
		...
		<td>&nbsp;</td>
		<td>
	<input type="button" onclick="newWindowOpen('?pid=27&action=print_staff_report<?php echo $staffurl;?>');" value="Print" style="cursor:pointer;" class="bgcolor_02"/>
...
?>		
					  <tr class="<?php echo $rowclass;?>">
						...
						<td align="center" class="narmal"><?php echo $absent;?><?php if($absent!= 0) { ?>&nbsp;
						<a href="javascript:void(0)" onclick="window.open('?pid=27&action=staff_report_absent_date&caid=<?php echo $staffreport['at_staff_id']."&from=$from&to=$to";?>',null,'width=600,height=400,left=50,top=30,scrollbars=yes,menubar=yes');"><?php echo viewIcon();?></a>
<?php } ?></td>
...
<?php 
	...
	?>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td><input type="button" onclick="newWindowOpen('?pid=27&action=print_staff_report<?php echo $staffurl;?>');" value="Print" style="cursor:pointer;" class="bgcolor_02"/>
</td>
		</tr>
 <?php    
...
&nbsp;                        </span><?php 
		...
		?>
		  ...
		  <table width="100%" height="32" border="0">
			<tr>
			  <td align="center" valign="middle"><input name="stud_updateattend_Submit" type="submit" style="cursor:pointer;" class="bgcolor_02" value="Submit" />
...
<?php }?></select></td>
		   ...
		   <?php 
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td height="32" align="center" valign="middle">
				  <input name="staff_updateattend_Submit" type="submit" style="cursor:pointer;" class="bgcolor_02" value="Submit" />
&nbsp;
