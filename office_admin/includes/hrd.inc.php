...
if($action == 'edit_tc')
{
	if(isset($_POST['update_certi']))
	{
		$query = "UPDATE `es_transferstudent` SET 
			`date`='".mysqli_real_escape_string($mysqli_con, $_POST['date'])."',
			`name_of_student`='".mysqli_real_escape_string($mysqli_con, $_POST['name_of_student'])."',
			`mother_name`='".mysqli_real_escape_string($mysqli_con, $_POST['mother_name'])."',
			`grno`='".mysqli_real_escape_string($mysqli_con, $_POST['grno'])."',
			`religion`='".mysqli_real_escape_string($mysqli_con, $_POST['religion'])."',
			`place_of_birth`='".mysqli_real_escape_string($mysqli_con, $_POST['place_of_birth'])."',
			`date_of_birth`='".mysqli_real_escape_string($mysqli_con, $_POST['date_of_birth'])."',
			`date_of_birth_in_words`='".mysqli_real_escape_string($mysqli_con, $_POST['date_of_birth_in_words'])."',
			`last_school`='".mysqli_real_escape_string($mysqli_con, $_POST['last_school'])."',
			`date_of_admission`='".mysqli_real_escape_string($mysqli_con, $_POST['date_of_admission'])."',
			`progress`='".mysqli_real_escape_string($mysqli_con, $_POST['progress'])."',
			`conduct`='".mysqli_real_escape_string($mysqli_con, $_POST['conduct'])."',
			`date_of_leaving`='".mysqli_real_escape_string($mysqli_con, $_POST['date_of_leaving'])."',
			`last_standard`='".mysqli_real_escape_string($mysqli_con, $_POST['last_standard'])."',
			`last_standard_join`='".mysqli_real_escape_string($mysqli_con, $_POST['last_standard_join'])."',
			`reason`='".mysqli_real_escape_string($mysqli_con, $_POST['reason'])."',
			`no_of_present_days`='".mysqli_real_escape_string($mysqli_con, $_POST['no_of_present_days'])."',
			`remarks`='".mysqli_real_escape_string($mysqli_con, $_POST['remarks'])."'
			WHERE `id`='".mysqli_real_escape_string($mysqli_con, $_GET['tc_id'])."'";
