                  ...
                  <div class="row">
                    <table class="table table-bordered table-condensed table-striped">
                      <thead>
                        ...
                        <td align="center"><?php echo $subject['es_subjectname']; ?><br>(<?php echo $subject['total_marks'];?> M)</td>
                        <?php } ?>
                      </thead>
                      <tbody>
                      <?php
                        ...
                        <tr>
                          ...
                          ?>
                          <td <?php echo ($mark<$subject['pass_marks'])?'class="danger"':''; ?> align="center">
                            <?php echo $mark['es_marksobtined']; ?>
                          </td>
                        <?php } ?>
                        </tr>
                      <?php } ?>
