	...
	<section>
		<form action='' method='post'>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
				<label>Caste</label>
				<input type='text' name='caste' class="form-control" value='<?php echo $caste; ?>'  />
			</div>


			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
				<?php if($action!='edit'){ ?>
	 				<input type='submit' class="form-control btn btn-info" name='addcaste' value='Submit'/>
	 			<?php } else {?>
	 				<input type='submit' class="form-control btn btn-info" name='addcaste' value='Update' class="bgcolor_02"/>
	 			<?php } ?>
			</div>
		</form>
	</section>
	...
	<section>
		<table class="table table-bordered table-striped table-hover">
			...
			<?php if(is_array($caste_array) && count($caste_array)>0){
	 		...
	 		?>
	 			<tr>
	 				<td><?php echo $i; ?></td><td><?php echo ucfirst($each_caste['caste']);?></td>
	 				<td><?php echo date('d/m/Y',strtotime($each_caste['created_on']));?></td>
	 				<td><a href="?pid=94&action=edit&caste_id=<?php echo $each_caste['caste_id']; ?>&page=caste">
...
<section>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
		...
		<input type='text' name='place_name' value='<?php echo $place_name; ?>' class="form-control"  />
	</div>

	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
	 	<?php if($action!='edit'){ ?>
	 	<input type='submit' name='addcaste' value='Submit' class="form-control btn btn-info"/>
	 	<?php } else {?>
	 	<input type='submit' name='addcaste' value='Update' class="form-control btn btn-info"/>
	 	<?php } ?>
	</div>
	</form>
</section>
	...
	<table class="table table-hover table-striped table-bordered">
		...
		<tbody>
			...
			?>
	 			<tr>
	 				<td><?php echo $i; ?></td>
	 				<td><?php echo ucfirst($each_caste['place_name']);?></td>
	 				<td><?php echo func_date_conversion('Y-m-d','d/m/Y',$each_caste['created_on']);?></td>
	 				<td><a href="?pid=94&action=edit&tr_place_id=<?php echo $each_caste['tr_place_id']; ?>&page=transport"><img src="images/b_edit.png" border="0" /></a>&nbsp;
	 					<?php
