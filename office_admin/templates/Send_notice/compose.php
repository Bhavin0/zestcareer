						...
						<div class="panel-body">
							<div class="tabs nomargin">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#tab1_nobg" data-toggle="tab" aria-expanded="true">
											<i class="main-icon fa fa-group"></i> Student
										</a>
									</li>
									<li class="">
										<a href="#tab2_nobg" data-toggle="tab" aria-expanded="false">
											<i class="main-icon fa fa-user"></i> Staff
										</a>
									</li>
								</ul>
								...
								<div class="tab-content transparent">
									<div id="tab1_nobg" class="tab-pane active">
										<form method="post" action="">
										 ...
										 <button type="submit" name="send_notice" class="btn btn-primary pull-right" value="send_notice" id="submit_btn">SEND MESSAGE</button>
			                            </form>
									</div>
									 <!-- tab content 1 end-->
									 <!-- tab content 2-->
									<div id="tab2_nobg" class="tab-pane">
										<form method="post" action="">
											...
											<label><b>Staff</b><font color="#FF0000"><b>*</b></font></label>
												<select class="form-control selectpicker" data-live-search="true" name="data[to_id]" required="required">
