                            ...
                            <div class="col-md-12 table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            $query .= " AND student_attendance.teacher_id = '".$_GET['teacher'];
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="?pid=140&action=attendancesheet_report&attendance_id=<?php echo $test['attendance_id']; ?>" class="btn btn-info btn-xs">&nbsp;<i class="fa fa-table"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
