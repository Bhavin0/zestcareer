	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<table class="table table-bordered table-hover table-striped table-condensed">
				...
				?>
					<tr>
						<td><?php echo $indclass['es_classname']; ?></td>
			  			<td>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="title elipsis">
				<strong>Time Table (<?php echo classname($es_class); ?>) </strong>
			</span>
		</div>
		<div class="panel-body">
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				...
				if(is_array($errormessage) && count($errormessage)>=1)
				{
					...
					{
						echo "<strong>".$eacherrormessage."</strong><br>";
					}
				}
				else
				{
					echo"<strong>".$sucessmessage[$emsg]."</strong>";
				}
				?>
			</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<strong class="pull-right">
					[<a href="?pid=106&action=edittimetable&es_class=<?php echo $es_class; ?>" class="error_msg" >Reset</a>]
				</strong>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-lg-offset-1 form-group">
				<div class="col-lg-7 col-md-7 col-12 col-xs-12 bottom-align-text">
					Start Time (HH:MM:SS)
				</div>
				<div class="col-lg-5 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_startfrom" value="<?php	echo $school_start_time=$subject_det['es_startfrom']; ?>" class="form-control input-sm" />
				</div>
				...
				<div class="col-lg-5 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_endto" value="<?php	echo $number_of_periods=$subject_det['es_endto']; ?>" class="form-control input-sm" />
				</div>
				
				<div class="col-lg-7 col-md-7 col-12 col-xs-12 bottom-align-text">
					Each Period Duration (Min)
				</div>
				<div class="col-lg-5 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_duration" value="<?php	echo $period_duration=$subject_det['es_duration']; ?>" class="form-control input-sm" />
				</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
				<div class="col-lg-8 col-md-9 col-12 col-xs-12 bottom-align-text">
					Break 1 Duration (Min)
				</div>
				<div class="col-lg-4 col-md-3 col-12 col-xs-12">
					<input type="text" name="es_breakfrom" value="<?php	echo $break=$subject_det['es_breakfrom']; ?>" class="form-control input-sm"/>
				</div>
				<div class="col-lg-8 col-md-7 col-12 col-xs-12 bottom-align-text">
					Break after period
				</div>
				<div class="col-lg-4 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_breakto" value="<?php	echo $break_position=$subject_det['es_breakto']; ?>" class="form-control input-sm"/>
				</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
				<div class="col-lg-8 col-md-7 col-12 col-xs-12 bottom-align-text">
					Break 2 Duration (Min)
				</div>
				<div class="col-lg-4 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_lunchfrom" value="<?php	echo $lunch=$subject_det['es_lunchfrom']; ?>" class="form-control input-sm"/>
				</div>
				<div class="col-lg-8 col-md-7 col-12 col-xs-12 bottom-align-text">
					Break after period
				</div>
				<div class="col-lg-4 col-md-5 col-12 col-xs-12">
					<input type="text" name="es_lunchto" value="<?php	echo $lunch_position=$subject_det['es_lunchto']; ?>" class="form-control input-sm"/>
				</div>
