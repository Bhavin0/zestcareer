    ...
    { 
      ...
      else
      {
        ...
        <tr>
          ...
          <td>
            <a href="?pid=36&action=exam_detail&exam_id=<?php echo $exam['es_exam_academicid']; ?>" class="btn btn-info btn-xs" title="View Subjects">
              &nbsp;<i class="fa fa-eye"></i>
            </a>

            <a href="?pid=36&action=enter_exam_batch_marks&exam_id=<?php echo $exam['es_exam_academicid']; ?>" class="btn btn-warning btn-xs" title="Enter all Subject's Marks">
              &nbsp;<i class="fa fa-pencil"></i>
            </a>

            <a href="?pid=36&action=view_exam_batch_marks&exam_id=<?php echo $exam['es_exam_academicid']; ?>" class="btn btn-info btn-xs" title="View all Subject's Marks">
