        	...
        	<div id="content" class="dashboard" style="padding-top: 5px;">
          		...
          		<!-- PANEL START -->
                      ...
                      $class_detail = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT * FROM es_classes WHERE es_classesid=".$_GET['class_id'])); //fetches detail of semester
                          ...
                          $grades = mysqli_query($mysqli_con, "SELECT * FROM grades_setting ORDER BY grade_id"); //fetch grade
                			?>
                      					...
                      					<?php
                        					...
                        					<tr>
                          						...
                          						while($activity = mysqli_fetch_assoc($activities)) {
                          							...
                          							{
                          								$stud_grade = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT grade FROM student_activity_grades WHERE student_activtiy_examid=".$activity['student_activtiy_examid']." AND student_id=".$student['es_preadmissionid']), MYSQLI_ASSOC);
                          							}
                          							else
                          							{
                          								unset($stud_grade);
