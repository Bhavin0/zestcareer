...
if(is_array($studentwiseReportList_date) && count($studentwiseReportList_date)>0 &&  $workdays_date!=0 ) {?>
	    			<tr class="bgcolor_02">
                        <td width="28%" height="18" align="center"><strong>School&nbsp;Working&nbsp;Days</strong></td>
                        <td width="27%" align="center"><strong>&nbsp;Present&nbsp;days</strong></td>
						<td width="29%" align="center"><strong>&nbsp;Absent days</strong></td>
...
?>                      <tr class="<?php echo $rowclass;?>">
                       <td align="center" class="narmal"><?php echo $workdays_date;?></td>
                        <td align="center" class="narmal"><?php echo $presentdays_date;?></td>
						<td align="center" class="narmal"><?php echo $absent;?><?php if($absent!= 0) { ?>&nbsp;<a href="javascript:void(0)" onclick="window.open('?pid=3&action=class_report_absent_date&caid=<?php echo $studid."&from=$from&to=$to" ;?>',null,'width=600,height=400,left=50,top=30,scrollbars=yes,menubar=yes');"><?php echo viewIcon();?></a><?php } ?></td>
                        <?php if($workdays_date!="") { 
						$percent = ($presentdays_date/$workdays_date) * 100; ?>
...
?>
					  ...
					  <tr>
                          <td align="center" valign="middle">&nbsp;<input name="Submit22" type="button" onclick="window.open('?pid=3&action=print_stud_report<?php echo $studurl;?>',null,'width=700,height=400,scrollbars=yes,toolbar=no,directories=no,status=no,menubar=yes,left=140,top=30');" class="bgcolor_02" style="cursor:pointer;"  value="Print" /></td>
</tr>
