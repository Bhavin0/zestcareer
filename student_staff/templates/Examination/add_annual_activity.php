...
<html lang="en-US">
  <head>
    ...
    <title>Add Annual Activity</title>
            ...
            <!-- PANEL START -->
	          <div class="panel panel-primary">
		          <div class="panel-heading">
			          <span class="elipsis title"><strong>Add Annual Activity</strong></span>
		          </div>
		          ...
		          <div class="panel-body">
		            <form action="" method="post">
								  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
									  ...
									  <select name="pre_year" class="form-control selectpicker" id="ac_year" required="required" data-live-search="true" onchange="fetchclass(this.value)">
								  ...
								  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
								    ...
								    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
									   ...
									   <select class="form-control selectpicker" id="classes" onchange="fetchstudents(this.value)" name="class[]" required="required" multiple="" data-live-search="true">
									   </select>
								    </div>

								    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
									    <label><b>Select Semester</b></label>
										  <select class="form-control selectpicker" id="semesters" name="semesters[]" multiple="" data-live-search="true">
									    </select>
								    </div>

								    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
									    <label><b>Exam Type</b></label>
										<select class="form-control selectpicker" name="activity[]" required="required" data-live-search="true" multiple="">
										    <?php
								    ...
								    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
									    <input type="submit" name="add_activity" value="SUBMIT" class="btn btn-primary pull-right">
								    </div>
							    </form>
                			</div>
              			</div>
