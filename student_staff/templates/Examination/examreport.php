...
<html lang="en-US">
    ...
    <body>
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="panel panel-primary">
                        <div class="panel-heading">
                           <span class="title elipsis"><strong>Examinations</strong></span>
                        </div>

                            <div class="panel-body">

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                    <a href="?pid=36&action=createexam" class="btn btn-primary pull-right" target="_blank">
        ...
        function fetch_detail()
        {
            ...
            xmlhttp.open("GET","?pid=17&action=examlist_ajax&ac_year="+ac_year+"&class_id="+class_id,true);
            xmlhttp.send();
        }
