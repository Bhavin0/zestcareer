									...
									<div class="panel-body">
                          				 <div class="table-responsive">
											<table class="table table-hover table-vertical-middle nomargin">
												...
												<tbody>
											  		<?php 
													$sql = "SELECT es_staff.st_firstname, es_staff.st_lastname,es_notice_messages.* FROM es_notice_messages INNER JOIN es_staff ON es_staff.es_staffid = es_notice_messages.to_id WHERE to_type = 'staff'";
													...
													<tr>
														...
														<td><?php  echo $row['st_firstname']." ".$row['st_lastname'];?></td>
														  ...
														  <td><a href="?pid=57&action=subject&sub_id=<?php echo $row['es_messagesid'];?>"><?php echo $row['subject'];?></a></td>
														
														<td><?php echo YMDtoDMY($row['notice_date']);?>
													</tr>
														 <?php } ?>
												</tbody>
											</table>
