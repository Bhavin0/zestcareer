            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div id="panel-misc-portlet-color-r2" class="panel panel-danger">
                  ...
                  <div class="panel-footer">
                    <a href="index.php?pid=58&action=holidayslist" class="btn btn-danger btn-xs"> View All </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div id="panel-misc-portlet-color-r2" class="panel panel-success">
                  ...
                  <div class="panel-footer">
                    <a href="index.php?pid=54&action=album_list" class="btn btn-success btn-xs"> View All </a>
                    <a href="index.php?pid=54&action=add_album" class="btn btn-success btn-xs pull-right"> Add New </a>
                  </div>
                </div>
              </div>
              </div>
