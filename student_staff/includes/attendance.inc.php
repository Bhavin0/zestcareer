...
sm_registerglobal('pid', 'action', 'emsg', 
		  ...
		  'at_staff_id',
		  'at_staff_name',
		  'at_staff_desig', 'at_staff_attend', 'at_staff_remarks', 'at_time_in', 'at_time_out', 'at_std_class_report', 'at_staff_dept1', 'at_std_wise_class_report', 'at_stdregno', 'student_report_submit', 'at_std_wise_name', 'dc1', 'dc2', 'at_staffwise_dept', 'at_staffid', 'at_staff_wise_name', 'staffwise_report_submit','class_student_report_submit','caid','from','to'
		  );
/**
