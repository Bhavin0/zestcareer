    ...
    <table class="table table-bordered table-striped">
        ...
        { 
            ...
            <tr class="info">
                ...
                <th>
                    <a href="?pid=36&action=enter_bunch_scholastic_marks&class_id=<?php echo $_GET['class_id']; ?>&semester_id=<?php echo $sem['semester_id']; ?>" class="btn btn-info btn-xs" target="_blank">
            ...
            else
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="?pid=36&action=enter_scholastic_marks&student_activtiy_examid=<?php echo $activity['student_activtiy_examid']; ?>" class="btn btn-info btn-xs">
                            <i class="fa fa-pencil"></i>
                        </a>
                    </td>
                </tr>
