...
if ($action=='voucher_entry') {
	$contra = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT COUNT(*) FROM es_voucherentry WHERE es_vouchertype='Contra' AND es_voucherdate='".date('Y-m-d')."'"), MYSQLI_NUM);
	$payment = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT COUNT(*) FROM es_voucherentry WHERE es_vouchertype='Payment' AND es_voucherdate='".date('Y-m-d')."'"), MYSQLI_NUM);
	$receipt = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT COUNT(*) FROM es_voucherentry WHERE es_vouchertype='Receipt' AND es_voucherdate='".date('Y-m-d')."'"), MYSQLI_NUM);
	$journal = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT COUNT(*) FROM es_voucherentry WHERE es_vouchertype='Journal' AND es_voucherdate='".date('Y-m-d')."'"), MYSQLI_NUM);
}
