		...
		<?php
		 for($i=0; $i<count($notice_view); $i++) 
		 	...
		 	<tr>
                ...
                <td>
                  <a href="?pid=37&action=editnotice&editnotice=<?php echo $notice_view[$i]['es_noticeid'];?>" title="Edit" class="btn btn-info btn-xs">
                    <i class="fa fa-pencil-square-o"></i>
                  </a> 
                  <a href="?pid=37&action=notice&deletnoticeid=<?php echo $notice_view[$i]['es_noticeid'];?>" 
                  title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('are you sure you want to delete?'); ">
