    	           ...
    	           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			            <div class="panel panel-primary">
				            <div class="panel-heading">
					           <span class="elipsis title"><strong>Edit Purchase Order</strong></span>
				            </div>
				            ...
				            <div class="panel-body">
                                ...
                                ?>
                                <form action="?pid=7&action=edit_order" method="post" >
                                    <div class="row">
                                        <h4>&nbsp;Order Details</h4>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <span class="form-control"><?php echo $_GET['order_id']; ?></span>
                                        <input type="hidden" name="order_id" value="<?php echo $_GET['order_id']; ?>">
                                    </div>

                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                                        <label><b>Order Date</b></label>
                                        <input class="datepicker form-control" name="order_date" readonly value="<?php echo $order['order_date']; ?>">
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <select name="in_suplier_name" id="in_suplier_name" class="form-control">
                                            ...
                                            $selected = ($order['in_suplier_id']==$supplier['es_in_supplier_masterid'])?'selected':'';
                                                echo"<option value='".$supplier['es_in_supplier_masterid']."' ".$selected.">".$supplier['in_name']."</option>";
                                            } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php while($row = mysqli_fetch_assoc($ord_items)) { ?>
                                                <tr>
                                                    <td width="30%">
                                                        <select class="category form-control" name="item_category[]">
                                                            ...
                                                            {
                                                                $selected = ($row['item_category']==$category_json[$i]['es_in_categoryid'])?'selected':'';
                                                    ...
                                                    <td width="35%">
                                                        <?php $sub_items = mysqli_query($mysqli_con, "SELECT * FROM es_in_item_master WHERE in_category_id =".$row['item_category']); ?>
                                                        <select class="items form-control" name="item_id[]">
                                                            <option selected="" disabled="">--SELECT ITEM--</option>
                                                            <?php
                                                                while($sub_item = mysqli_fetch_assoc($sub_items))
                                                                {
                                                                    $selected = ($sub_item['es_in_item_masterid']==$row['item_id'])?'selected':'';
                                                    ...
                                                    <td width="20%">
                                                        <input type="number" name="item_qty[]" class="form-control" value="<?php echo $row['ordered_qty']; ?>">
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                        <button name="edit_order" type="submit" class="btn btn-primary pull-right" value="1">SUBMIT</button>
                                    </div>
                                </form>
                            </div>
                        </div>
