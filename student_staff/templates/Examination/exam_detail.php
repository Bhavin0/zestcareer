                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="?pid=17&action=enter_marks&exam_id=<?php echo $exam['es_exam_detailsid']; ?>" class="btn btn-info btn-xs" title="Enter Marks">
                            &nbsp;<i class="fa fa-pencil"></i>
                          </a>
                          <?php }
                          else { ?>
                          <a href="?pid=17&action=view_marks&exam_id=<?php echo $exam['es_exam_detailsid']; ?>" class="btn btn-warning btn-xs" title="View Marks">
                            &nbsp;<i class="fa fa-eye"></i>
                          </a>
                          <?php } ?>
                          
                          <?php if($exam['status']=='Submitted') { ?>
                          <a href="?pid=17&action=enter_marks&exam_id=<?php echo $exam['es_exam_detailsid']; ?>" class="btn btn-info btn-xs" title="Edit Marks">
