    ...
    ?>
      <section id="middle">
        <header id="page-header">
          ...
          <ol class="breadcrumb">
            <li><a href="?pid=44"><?php echo $_SESSION['eschools']['student_name'];?></a></li>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
              <div class="col-md-3 col-sm-12">
                <div class="box info">
                  <div class="box-title">
                    <h4><a href="index.php?pid=2&action=myprofile"> MY PROFILE</a></h4>
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div id="panel-misc-portlet-color-r2" class="panel panel-warning">
                  ...
                  <div class="panel-footer">
                    <a href="?pid=33&action=noticeboard" class="btn btn-warning btn-xs"> View All </a>
                  </div>
                </div>
              </div>
