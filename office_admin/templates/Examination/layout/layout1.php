        ...
        <tr>
          ...
          <?php 
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center"></th>';
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center"></th>';
    ...
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        ...
        ?>
          ...
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:<?php echo $color; ?>;" width="8%" align="center"></th>
        <?php
        $i++;
          }
        echo"</tr>";
