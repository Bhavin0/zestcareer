  ...
  <tr>
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="10%">
          ...
          ?>
          <th rowspan="2" style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;"><b>Aggregate</b></th>
        </tr>
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="10%"><b>Subject</b>
          </th>
          <?php 
        ...
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="10%"><b><?php echo $subject['es_subjectname']; ?></b>
          </th>
          <?php 
            mysqli_data_seek($terms, 0);
            $aggregate_marks = 0;
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;">'.grade_check($term_wise_mark_obtained, $grades_setting).'</th>';
    ...
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        ...
        ?>
          ...
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="8%">
            <?php
