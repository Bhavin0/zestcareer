...
if(isset($_POST['start_test']))
{
	...
	$query = "INSERT INTO `isd_class_tests`(`class_test_date`, `academic_year_id`, `standard_id`, `teacherid`, `subject_id`, `total_marks`) VALUES (
...
if($_GET['action']=='delete_test')
{

	$update_query = "UPDATE `isd_class_tests` SET `test_status`='DELETED' WHERE `class_test_id`=".$_GET['test_id'];

	mysqli_query($mysqli_con, $update_query) or die(mysqli_error($mysqli_con));

	header('Location: index.php?pid=138&action=view_tests');
