...
$terms = mysqli_query($mysqli_con, "SELECT DISTINCT semester_id FROM es_exam_academic WHERE class_id=".$student_detail['pre_class']." AND academic_year=".$_GET['ac_year']." ORDER BY semester_id DESC LIMIT 1");
        ...
        <tr>
          ...
          <?php 
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              echo '<b>Academic Year (100 Marks)</b>';
              echo'</th>';
            }
          ?>
        </tr>
    ...
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        <tr>
          <?php
          $i = 1;
          $activity_terms = mysqli_query($mysqli_con, "SELECT DISTINCT semester_id FROM student_activtiy_exam WHERE academic_year=".$_GET['ac_year']." AND class_id=".$student_detail['pre_class']." ORDER BY semester_id DESC LIMIT 1");
