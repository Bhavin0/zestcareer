                     ...
                     <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <?php
                                $material_qry = mysqli_query($mysqli_con, "SELECT `es_studymaterial`.*, `es_classes`.`es_classname` FROM `es_studymaterial` INNER JOIN `es_classes` ON `es_classes`.`es_classesid` = `es_studymaterial`.`sm_class_id` INNER JOIN `es_subject` ON `es_subject`.`es_subjectid` = `es_studymaterial`.`sm_subject_id` WHERE `es_studymaterial`.`status`='active' AND `es_studymaterial`.`es_studymaterialid`=".$_GET['studymaterialid']." AND `es_studymaterial`.`sm_class_id`=".$current_academic_detail['pre_class']." ") or die(MYSQLI_ERROR($mysqli_con));
