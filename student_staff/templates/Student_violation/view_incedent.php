                     ...
                     <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <?php
                               $report = mysqli_query($mysqli_con, "SELECT `student_violation`.*, `es_classes`.`es_classname`, `es_preadmission`.`pre_name`,`es_preadmission`.`middle_name`,`es_preadmission`.`pre_lastname`, `isd_class_division`.`division_name` FROM `student_violation` INNER JOIN `es_classes` ON `es_classes`.es_classesid = `student_violation`.`es_classesid` INNER JOIN `es_preadmission` ON `es_preadmission`.es_preadmissionid = `student_violation`.`es_preadmissionid` INNER JOIN `isd_class_division` ON `isd_class_division`.`class_division_id` = `student_violation`.`division_id` WHERE `student_violationid` = ".$_GET['student_violationid']);
