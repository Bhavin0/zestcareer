							...
							<table class="fooTableInit"><!-- add .fooMinimal for minimal skin and remove foo css theme (footable.standalone.css) -->
								...
								<?php $i = 1; while($material = mysqli_fetch_assoc($materials)) { ?>
									<tr>
										...
										<td>
											<a href="?pid=51&action=view_material_detail&studymaterialid=<?php echo $material['es_studymaterialid']; ?>" class="btn btn-info btn-xs">&nbsp;<i class="fa fa-eye"></i></a>
											<a href="?pid=51&action=edit_material&studymaterialid=<?php echo $material['es_studymaterialid']; ?>" class="btn btn-warning btn-xs">&nbsp;<i class="fa fa-pencil-square-o"></i></a>
											<a href="?pid=51&action=delete_material&studymaterialid=<?php echo $material['es_studymaterialid']; ?>" onclick="return confirm('are you sure? you want to delete it?')" class="btn btn-danger btn-xs">&nbsp;<i class="fa fa-trash-o"></i></a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
