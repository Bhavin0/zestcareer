...
<table width="100%">
  <tr>
    <td align="left" width="20%" rowspan="4">
      <img src="<?php echo base_url('assets/images/cbse-logo.png'); ?>" style="height:80px;">
    </td>
    ...
    <td align="right" width="20%" rowspan="4">
      <img src="<?php echo base_url('includes/images/ac_year_2_logo.png'); ?>" style="height:80px;">
    </td>
  </tr>
  ...
  <tr>
    <td colspan="3" style="font-size: 10px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="4">
        <tr>
          <th colspan="2"><b>Student Name : </b> <?php echo $student_detail['pre_name']." ".$student_detail['middle_name']." ".$student_detail['pre_lastname']; ?></th>
          <th><b>GR No. : </b> <?php echo $student_detail['grno']; ?></th>
        </tr>
        <tr>
  ...
  <tr>
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="11%"><b>Scholastic Areas</b></th>
          <?php 
            $i = 1;
          ...
          ?>
          <th rowspan="2" style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="9%"><b>Aggregate</b></th>
        </tr>
        <tr>
          ...
          <?php 
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              {
                echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" align="center" width="7%">';
                echo '<b>'.$exams_type['es_examname'].'</b>';
                echo'</th>';
              }
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="7%" align="center"><b>Marks Obtained (100)</b></th>';
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" align="center" width="5%"><b>Grade</b></th>';
            }
          ?>
        </tr>
        <?php
        ...
        <tr>
          ...
          <?php 
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              while($exams_type = mysqli_fetch_assoc($exams_types))
              {
                ...
                echo'<td style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center"></td>';
          ...
          ?>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" align="center"><?php echo grade_check($aggregate_marks / 2, $grades_setting); ?></th>
        </tr>
        <?php
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        ...
        <tr>
          ...
          while ($activity_term = mysqli_fetch_assoc($activity_terms))
          {
            ...
            <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" width="8%" align="center"><b>Grade</b></th>
            <?php
          }
          ?>
        </tr>
