...
{
  $result_detail = mysqli_fetch_array($detail_array, MYSQLI_ASSOC);
}
...
<table width="100%">
  <tr>
    <td align="left" width="20%" rowspan="4">
      <img src="<?php echo base_url('includes/images/blank.png'); ?>" style="height:80px;">
    </td>
    <td align="center" width="60%" style="font-size:18px; font-family: times;">
      <img src="<?php echo base_url('includes/images/blank.png'); ?>" style="height:20px;">
    </td>
  ...
  <tr>
    <td align="center" width="60%" style="font-size:18px; font-family: times; color: white;" >
      <b><?php echo $academic['fi_schoolname']; ?></b>
    </td>
  </tr>

  <tr>
    <td align="center" style="font-size:8px; font-family: times; color: white;">
      <b><?php echo nl2br($academic['fi_address']); ?></b>
    </td>
  </tr>

  <tr>
    <td align="center" style="font-size:10px; font-family: times; color: white;">
      <br><br>
  ...
  <tr>
    <td colspan="3" style="font-size: 10px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="4">
        <tr>
          <th colspan="2" style="color: white;"><b>Student Name : </b> <?php echo $student_detail['pre_name']." ".$student_detail['middle_name']." ".$student_detail['pre_lastname']; ?></th>
          <th style="color: white;"><b>GR No. : </b> <?php echo $student_detail['grno']; ?></th>
        </tr>
        <tr>
          <th colspan="3" style=" color: white;"><b>Mother's/Father's/Guardian Name : </b> <?php echo $student_detail['pre_mothername']; ?></th>
        </tr>
        <tr>
          <th width="25%" style=" color: white;"><b>Roll No. : </b> <?php echo $student_detail['scat_id']; ?></th>
          <th width="35%" style=" color: white;"><b>Class/Section : </b> <?php echo $student_detail['es_classname']; ?></th>
          <th width="40%" style=" color: white;"><b>Date of Birth : </b> <?php echo date_format(date_create($student_detail['pre_dateofbirth']), 'd/m/Y'); ?></th>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" width="11%"><b>Scholastic Areas</b></th>
          <?php 
            $i = 1;
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;" colspan="'.($exams_types[0] + 2).'" align="center" width="40%">';
              echo '<b>Term '.$i++.'</b>';
              echo'</th>';
            }
          ?>
          <th rowspan="2" style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;" width="9%"><b>Aggregate</b></th>
        </tr>
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;"><b>Subject</b>
          </th>
          <?php 
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              {
                echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;" align="center" width="7%">';
                echo '<b>'.$exams_type['es_examname'].'</b>';
                echo'</th>';
              }
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;" width="7%" align="center"><b>Marks Obtained (100)</b></th>';
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;" align="center" width="5%"><b>Grade</b></th>';
            }
          ?>
        </tr>
        <?php
        ...
        <tr>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:white;"><b><?php echo $subject['es_subjectname']; ?></b>
          </th>
          <?php 
            mysqli_data_seek($terms, 0);
            $aggregate_marks = 0;
            ...
            while($term = mysqli_fetch_assoc($terms))
            {
              ...
              while($exams_type = mysqli_fetch_assoc($exams_types))
              {
                ...
                $color = ($i == 1)?'white':'#000000';

                echo'<td style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center">'.$mark['es_marksobtined'].'</td>';
                $term_wise_mark_obtained = $term_wise_mark_obtained + $mark['es_marksobtined'];
              }
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center">'.$term_wise_mark_obtained.'</th>';
              echo'<th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:'.$color.'" align="center">'.grade_check($term_wise_mark_obtained, $grades_setting).'</th>';
              $aggregate_marks = $aggregate_marks + $term_wise_mark_obtained;
              $i++;
            }
          ?>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;" align="center"><?php echo grade_check($aggregate_marks / 2, $grades_setting); ?></th>
        </tr>
        <?php
    ...
    <td colspan="3" style="font-size: 8px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        <tr>
          ...
          {
            ?>
            <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" colspan="3"><b>Co-scholastic Areas: Term <?php echo $i++; ?> [on a 3-point (A-C) grading scale]</b></th>
            <?php
          }
          ?>
        </tr>
        <tr>
          ...
          {
            ?>
            <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" width="42%"></th>
            <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" width="8%" align="center"><b>Grade</b></th>
            <?php
          }
          ?>
        </tr>
        ...
        ?>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" width="42%"><b><?php echo $activity['activity_name']; ?></b></th>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:<?php echo $color; ?>;" width="8%" align="center"><?php echo $activity_grade['grade']; ?></th>
        <?php
        $i++;
          }
        echo"</tr>";
      ...
      <table width="100%"  cellspacing="0" cellpadding="2" style="font-size: 8px;">
        ...
        echo"<tr>";
          ...
          while ($activity_term = mysqli_fetch_assoc($activity_terms))
          {
            ...
            $activity_grade = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT student_activity_grades.grade FROM student_activity_grades INNER JOIN student_activtiy_exam ON student_activtiy_exam.student_activtiy_examid = student_activity_grades.student_activtiy_examid WHERE student_activtiy_exam.semester_id='".$activity_term['semester_id']."' AND student_activtiy_exam.activity_id=".$activity['activity_id']." AND student_activity_grades.student_id=".$_GET['student_id']), MYSQLI_ASSOC);
        ?>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color: white;" width="42%"><b><?php echo $activity['activity_name']; ?>: Term-<?php echo $i++; ?> [on a 3-point (A-C) grading scale]</b></th>
          <th style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; color:<?php echo $color; ?>;" width="8%" align="center"><?php echo $activity_grade['grade']; ?></th>
        <?php
          }
        echo"</tr>";
  ...
  <tr>
    <td colspan="3" style="font-size: 10px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="4">
        <tr>
          <th width="20%" style="color: white;"><b>Final Grade: </b></th>
          <th style="border-bottom-width: 1px; border-bottom-style: dotted;"><?php echo grade_check(($final_marks / (mysqli_num_rows($subjects) * mysqli_num_rows($terms))), $grades_setting); ?></th>
          <th></th>
        </tr>
        <tr>
          <th width="32%" style="color: white;"><b>Class Teacher's Remark : </b></th>
          <th colspan="2" style="border-bottom-width: 1px; border-bottom-style: dotted;"><?php echo $result_detail['remarks']; ?></th>
        </tr>
        <tr>
          <th width="25%" style="color: white;"><b>Promoted to Class: </b></th>
          <th style="border-bottom-width: 1px; border-bottom-style: dotted;"><?php echo $result_detail['next_class']; ?></th>
          <th></th>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td colspan="3" style="font-size: 10px;">
      ...
      <table width="100%"  cellspacing="0" cellpadding="2">
        <tr>
          <th style="color: white;"><b>Place: </b> Gandhidham</th>
          <th rowspan="2" style="border-bottom-width: 1px; color: white;"><b>Signature of<br>Class Teacher : </b></th>
          <th rowspan="2" style="border-bottom-width: 1px; color: white;"><b>Signature of<br>Principal : </b></th>
        </tr>
        <tr>
          <th style="border-bottom-width: 1px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('d/m/Y'); ?></b></th>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
    <td colspan="3" style="font-size: 10px; color: white" align="center">
      <b>Instruction</b>
    </td>
  </tr>
  <tr>
    <td colspan="3" style="font-size: 8px; color: white;" align="center">
      <b>Grading Scale for scholastic areas:</b> Grades are awarded on a 5-point grading scale as follows
    </td>
  </tr>
  <tr>
    <td colspan="3" style="font-size: 8px; color: white;">
      <br><br>
      <table width="100%" cellspacing="0" cellpadding="2" align="center">
        ...
        <tr>
          <th></th>
          <th style="border-top-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-right-width: 1px; "><?php echo $grades_set['min_marks'].'-'.$grades_set['max_marks']; ?></th>
