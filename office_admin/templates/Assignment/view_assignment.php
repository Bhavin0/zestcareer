							...
							<table class="fooTableInit"><!-- add .fooMinimal for minimal skin and remove foo css theme (footable.standalone.css) -->
								...
								<?php $i = 1; while($assignment = mysqli_fetch_assoc($assignments)) { ?>
									<tr>
										...
										<td>
											<a href="?pid=4&action=view_assignment_detail&assignment_id=<?php echo $assignment['es_assignmentid']; ?>" class="btn btn-info btn-xs">&nbsp;<i class="fa fa-eye"></i></a>
											<a href="?pid=4&action=edit_assignment&assignment_id=<?php echo $assignment['es_assignmentid']; ?>" class="btn btn-warning btn-xs">&nbsp;<i class="fa fa-pencil-square-o"></i></a>
											<a href="?pid=4&action=delete_assignment&assignment_id=<?php echo $assignment['es_assignmentid']; ?>" onclick="return confirm('are you sure? you want to delete it?')" class="btn btn-danger btn-xs">&nbsp;<i class="fa fa-trash-o"></i></a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
