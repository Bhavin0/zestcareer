                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="panel panel-primary">
                        <div class="panel-heading">
                           <span class="title elipsis"><strong>Student Performance</strong></span>
                        </div>
                        <div class="panel-body">
                            <form action="?pid=138&action=performance" method="post">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" onchange="fetchclass(this.value)">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" id="classes" onchange="fetchdivision(this.value)" name="standard_id">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" id="divisions" name="division_id" onchange="fetchstudents(this.value)">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" required="required" name="student_id" id="students">
