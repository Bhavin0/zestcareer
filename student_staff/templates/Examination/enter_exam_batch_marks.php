                    				...
                    				<table class="table table-bordered table-condensed">
                      					<thead>
                        					...
                        					<th>
                        						...
                        						<br>
                        						(<?php echo $subject['total_marks'];?> M)
                      					...
                      					<?php
                        					...
                        					<tr>
                          						...
                          						while($subject = mysqli_fetch_assoc($subjects)) {
                          							...
                          							{
                          								$mark = mysqli_fetch_array(mysqli_query($mysqli_con, "SELECT es_marksobtined FROM es_marks WHERE es_examdetailsid=".$subject['es_exam_detailsid']." AND es_marksstudentid=".$student['es_preadmissionid']), MYSQLI_ASSOC);
                          							}
                          							else
                          							{
                          								unset($mark);
                          						...
                          						?>
                          						<td>
                            						<input type="number" name="obtained_marks[<?php echo $subject['es_exam_detailsid']; ?>][]" class="form-control" min="0" max="<?php echo $subject['total_marks']; ?>" value="<?php echo $mark['es_marksobtined']; ?>" required>
                          						</td>
                          						<?php } ?>
                        					</tr>
                        				<?php } ?>
